...
export default function Layout() {
  ...
  const NAV = [
    ...
    // Doctor + admin
    { to: '/doctor', label: 'Doctor view', icon: DoctorIcon, roles: ['admin', 'doctor'] },
    // Admin only
...
const S = {
  ...
  logoutBtn: { display: 'flex', alignItems: 'center', margin: '0 10px 16px', padding: '9px 12px', background: 'none', border: '1px solid rgba(0,0,0,0.08)', borderRadius: 8, color: '#888', fontSize: 13, cursor: 'pointer' },
  main: { flex: 1, padding: 28, overflowY: 'auto', background: '#f7f7f5' },
};

function QueueIcon() { return <svg width="16" height="16" viewBox="0 0 16 16" fill="none"><rect x="2" y="3" width="12" height="2" rx="1" fill="currentColor"/><rect x="2" y="7" width="8" height="2" rx="1" fill="currentColor"/><rect x="2" y="11" width="10" height="2" rx="1" fill="currentColor"/></svg>; }
function FollowupIcon() { return <svg width="16" height="16" viewBox="0 0 16 16" fill="none"><path d="M2 3h12v8H2z" rx="1" stroke="currentColor" strokeWidth="1.2" fill="none"/><path d="M2 3l6 5 6-5" stroke="currentColor" strokeWidth="1.2" fill="none"/></svg>; }
function PatientsIcon() { return <svg width="16" height="16" viewBox="0 0 16 16" fill="none"><circle cx="8" cy="5" r="3" stroke="currentColor" strokeWidth="1.2" fill="none"/><path d="M2 14c0-3 2.7-5 6-5s6 2 6 5" stroke="currentColor" strokeWidth="1.2" fill="none" strokeLinecap="round"/></svg>; }
function AnalyticsIcon() { return <svg width="16" height="16" viewBox="0 0 16 16" fill="none"><rect x="2" y="8" width="3" height="6" rx="1" fill="currentColor"/><rect x="6.5" y="5" width="3" height="9" rx="1" fill="currentColor"/><rect x="11" y="2" width="3" height="12" rx="1" fill="currentColor"/></svg>; }
function DoctorIcon() { return <svg width="16" height="16" viewBox="0 0 16 16" fill="none"><circle cx="8" cy="5" r="2.5" stroke="currentColor" strokeWidth="1.2" fill="none"/><path d="M3 14c0-2.8 2.2-5 5-5s5 2.2 5 5" stroke="currentColor" strokeWidth="1.2" fill="none" strokeLinecap="round"/><path d="M10 10v3M8.5 11.5h3" stroke="currentColor" strokeWidth="1.2" strokeLinecap="round"/></svg>; }
function SettingsIcon() { return <svg width="16" height="16" viewBox="0 0 16 16" fill="none"><circle cx="8" cy="8" r="2.5" stroke="currentColor" strokeWidth="1.2" fill="none"/><path d="M8 1v2M8 13v2M1 8h2M13 8h2M3 3l1.5 1.5M11.5 11.5L13 13M3 13l1.5-1.5M11.5 4.5L13 3" stroke="currentColor" strokeWidth="1.2" strokeLinecap="round"/></svg>; }
