...
const S = {
  ...
  todayStrip: { background: '#fff', border: '1px solid rgba(0,0,0,0.08)', borderRadius: 12, padding: '12px 14px', marginBottom: 16, display: 'flex', alignItems: 'center', gap: 12, flexWrap: 'wrap' },
  ...
  todayStats: { display: 'flex', gap: 16, flex: 1, flexWrap: 'wrap' },
  ...
  drStats: { display: 'flex', gap: 12, flexWrap: 'wrap' },
  ...
  barLabel: { width: 90, fontSize: 11, color: '#888', flexShrink: 0 },
  ...
  insightsGrid: { display: 'grid', gridTemplateColumns: 'repeat(1, minmax(0,1fr))', gap: 10, marginBottom: 20 },
