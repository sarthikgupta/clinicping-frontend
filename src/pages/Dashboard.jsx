  ...
  return (
    <div style={S.page}>
      ...
      <div style={S.greetRow}>
        <div>
          <h1 style={S.greet}>{greeting()}, {user?.name?.split(' ')[0]} 👋</h1>
...
const S = {
  ...
  greet: { fontSize: 24, fontWeight: 700, color: '#1a1a1a', margin: 0 },
  ...
  statCard: { borderRadius: 12, padding: '14px 16px', border: '1px solid rgba(0,0,0,0.05)' },
  ...
  shortcutGrid: { display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 12, marginBottom: 28 },
